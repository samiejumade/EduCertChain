window.CONTRACT = {
    ...
    network: 'http://localhost:8545', // Local Hardhat network
    explore: 'http://localhost:8545', // Local explorer
    chainId: '0x7A69', // Hardhat chainId
    
    // Sepolia Configuration
    // address: '<your-sepolia-deployed-contract-address>',
  ...
  function print_info(result, is_verified) {
    ...
    if (!is_verified) {
      ...
      $('#college-name').html(
        `<span cl
        ass="text-info"><i class="fa-solid fa-graduation-cap"></i></span> ${result[2]}`,
      )
